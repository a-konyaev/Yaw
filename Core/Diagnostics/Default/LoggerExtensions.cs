...
namespace Yaw.Core.Diagnostics.Default
{
    ...
    public static class LoggerExtensions
    {
        ...
        /// <param name="eventType">Важность события</param>
        /// <param name="properties">Данные события</param>
        ...
        /// <summary>
        /// Возвращает имя метода, который находится в стеке до методов самого класса
        /// </summary>
        /// <param name="type">тип, методы которого пропускаем</param>
        /// <returns>ИмяКласса.ИмяМетода</returns>
